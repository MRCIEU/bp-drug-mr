...
phen <- phen %>% 
         rename(
           your_column_name = sbp,
           your_column_name = dbp,
           your_column_name = tc,
           your_column_name = ldlc,
           your_column_name = tg,
           your_column_name = chd,
           your_column_name = stroke,
           your_column_name = hypertension,
         )
```
...
write.table(output, file="phen-cov-summary.txt", row=F, qu=F)
```
