# GWAS of LDL cholesterol adjusted for different relative medication corrections
...
# Read in input data
phen_con <- fread(paste0(dir,"/mrc_ldlc_adj_rel_med_afr.txt"), header=T, fill = T, na.strings = c("", NA), data.table = F, stringsAsFactors = FALSE)
...
phenotype_names <- c("ldlc_unadjusted","ldlc_10", "ldlc_20", "ldlc_30", "ldlc_40", "ldlc_50", "ldlc_60", "ldlc_70", "ldlc_80")
