...
est_effs <- function(dat) {
  ...
  ) %>% as_tibble() %>% mutate(measure=c("y", "y_obs", "y_nonmed", "y_med", "y_cov", "y_adj_approx"), n=c(nrow(dat), nrow(dat), nrow(datnonmed), nrow(datmed), nrow(dat), nrow(dat)), g="direct")
  ...
  ) %>% as_tibble() %>% mutate(measure=c("y", "y_obs", "y_nonmed", "y_med", "y_cov", "y_adj_approx"), n=c(nrow(dat), nrow(dat), nrow(datnonmed), nrow(datmed), nrow(dat), nrow(dat)), g="indirect")
...
measure_order <- c("y", "y_obs", "y_nonmed", "y_cov", "y_adj_approx")
