#!/bin/bash
#SBATCH --job-name=qctool_afr_snp_stats
#SBATCH --nodes=1
...
-og $out_dir/AFR/ukb_imp_chr"${SLURM_ARRAY_TASK_ID}"_v3_AFR.bgen \
-os $out_dir/AFR/ukb_imp_AFR.sample \
-incl-samples sample_ID_keep_AFR.txt \
-snp-stats \
-osnp $out_dir/AFR/snp_stats/snp_stats_chr"${SLURM_ARRAY_TASK_ID}"_AFR.txt
