...
awk '{if ($14>0.01 && $17>0.5){ print $2;}}' $data_dir/SAS/snp_stats/snp_stats_chr_"${SLURM_ARRAY_TASK_ID}"_SAS.txt > $out_dir/SAS/filtered/snp_list/snp_list_chr_"${SLURM_ARRAY_TASK_ID}"_SAS.txt
