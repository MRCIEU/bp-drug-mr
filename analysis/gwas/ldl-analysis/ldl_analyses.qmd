...
ex <- readRDS("pop_extract_clumped.rds")
...
The degree of replication of the p-value is line with expectation for the EAS and SAS populations. However, the AFR and HIS populations are lower than expected. 
