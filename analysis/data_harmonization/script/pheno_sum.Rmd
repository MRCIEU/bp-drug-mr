...
subset_phen <- phen[, c("IID", "dbp", "ldlc", "pp", "sbp", "tc", "tg")]
...
data.out.raw.int.rename <- data.out.raw.int %>% rename("dbp"="dbp_int", "ldlc"="ldlc_int", "pp"="pp_int", "sbp"="sbp_int", "tc"="tc_int", "tg"="tg_int")
raw_int <- merge(phen, data.out.raw.int.rename, by="IID")
subset_raw_int <- raw_int[, c("IID", "dbp", "ldlc", "pp", "sbp", "tc", "tg", "dbp_int", "ldlc_int", "pp_int", "sbp_int", "tc_int", "tg_int")] 
pearsons_raw_int <- rcorr(as.matrix(subset_raw_int[,2:13]))
...
pearsons_raw_int_out1 <- pearsons_raw_int_out[pearsons_raw_int_out$row !="dbp_int" & pearsons_raw_int_out$row !="ldlc_int" & pearsons_raw_int_out$row !="pp_int" & pearsons_raw_int_out$row !="sbp_int" & pearsons_raw_int_out$row !="tc_int" & pearsons_raw_int_out$row !="tg_int", ]
...
subset_int_phen_cov_pc <- int_phen_cov_pc[, c("IID", "dbp", "ldlc", "pp", "sbp", "tc", "tg", "sex", "age", "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10", "PC11", "PC12", "PC13", "PC14", "PC15", "PC16", "PC17", "PC18", "PC19", "PC20")]
...
subset_updated_dat1 <- updated_dat1[, c("IID", "dbp", "ldlc", "pp", "sbp", "tc", "tg")]
int_function<-function(x){
...
subset_updated_dat2 <- updated_dat2[, c("IID", "dbp", "ldlc", "pp", "sbp", "tc", "tg")]
int_function<-function(x){
...
subset_updated_dat3 <- updated_dat3[, c("IID", "dbp", "ldlc", "pp", "sbp", "tc", "tg")]
int_function<-function(x){
...
subset_dat_out1_cov_pc <- data_out1_cov_pc[, c("IID", "dbp", "ldlc", "pp", "sbp", "tc", "tg", "sex", "age", "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10", "PC11", "PC12", "PC13", "PC14", "PC15", "PC16", "PC17", "PC18", "PC19", "PC20")]
...
subset_dat_out2_cov_pc <- data_out2_cov_pc[, c("IID", "dbp", "ldlc", "pp", "sbp", "tc", "tg", "sex", "age", "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10", "PC11", "PC12", "PC13", "PC14", "PC15", "PC16", "PC17", "PC18", "PC19", "PC20")]
...
subset_dat_out3_cov_pc <- data_out3_cov_pc[, c("IID", "dbp", "ldlc", "pp", "sbp", "tc", "tg", "sex", "age", "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10", "PC11", "PC12", "PC13", "PC14", "PC15", "PC16", "PC17", "PC18", "PC19", "PC20")]
