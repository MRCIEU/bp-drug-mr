...
summary(lm(eurycomp ~ eurx1comp + eurx2comp + eurx3comp))

# Univariable MR (unweighted)
summary(lm(eurycomp ~ eurx1comp))
...
summary(lm(eurycomp ~ eurx1comp + eurx2comp + eurx3comp, weight = 1/diag(pcOmega)^2))

# Univariable MR (unweighted)
summary(lm(eurycomp ~ eurx1comp, weight = 1/diag(pcOmega)^2))
```
